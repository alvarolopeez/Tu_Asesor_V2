...
This project is indexed by GitNexus as **Tu_Asesor_V2** (1915 symbols, 2458 relationships, 31 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
