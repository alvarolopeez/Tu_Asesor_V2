...
This project is indexed by GitNexus as **Tu_Asesor_V2** (2138 symbols, 2779 relationships, 38 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
