...
This project is indexed by GitNexus as **Tu_Asesor_V2** (2218 symbols, 2885 relationships, 39 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
