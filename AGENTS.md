...
This project is indexed by GitNexus as **Tu_Asesor_V2** (2213 symbols, 2872 relationships, 38 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
