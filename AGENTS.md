...
This project is indexed by GitNexus as **Tu_Asesor_V2** (2312 symbols, 3117 relationships, 46 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
