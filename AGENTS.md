...
This project is indexed by GitNexus as **Tu_Asesor_V2** (3157 symbols, 4676 relationships, 125 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
