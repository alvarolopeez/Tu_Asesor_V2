...
This project is indexed by GitNexus as **Tu_Asesor_V2** (2857 symbols, 4198 relationships, 102 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
