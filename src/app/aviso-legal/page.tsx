  ...
  return (
    <main className="min-h-screen flex flex-col items-center pt-32 pb-24 px-4 bg-slate-50 relative overflow-x-hidden">
      ...
      <div className="w-full max-w-4xl relative z-10 bg-white shadow-xl rounded-2xl p-8 md:p-12 text-slate-700 leading-relaxed">
        <h1 className="text-4xl font-bold text-[#2C3E50] mb-8 font-heading">Aviso Legal</h1>
        
        <h2 className="text-2xl font-bold mt-8 mb-4 text-[#2C3E50] font-heading">1. Datos del Responsable</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4 text-[#2C3E50] font-heading">2. Objeto del Sitio Web</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4 text-[#2C3E50] font-heading">3. Condiciones de Uso y Herramientas Tecnológicas</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4 text-[#2C3E50] font-heading">4. Propiedad Intelectual e Industrial</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4 text-[#2C3E50] font-heading">5. Exclusión de Garantías y Responsabilidad</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4 text-[#2C3E50] font-heading">6. Legislación Aplicable y Jurisdicción</h2>
        <p className="mb-4">
