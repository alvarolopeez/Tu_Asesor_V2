  ...
  return (
    <main className="min-h-screen flex flex-col items-center pt-32 pb-24 px-4 bg-[#0f172a] text-white relative overflow-x-hidden">
      ...
      <div className="w-full max-w-4xl relative z-10 glass-effect bg-[#1E293B]/70 border border-white/5 backdrop-blur-md rounded-2xl p-8 md:p-12 text-slate-300 leading-relaxed shadow-2xl">
        <h1 className="text-4xl font-bold text-white mb-8 font-heading border-b border-white/10 pb-4">Política de Cookies</h1>
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4 text-[#FBBF24] font-heading">1. ¿Qué son las cookies?</h2>
        <p className="mb-4">
          Una cookie es un fichero que se descarga en su ordenador al acceder a determinadas páginas web. Las cookies permiten a una página web, entre otras cosas, almacenar y recuperar información sobre los hábitos de navegación de un usuario o de su equipo y, dependiendo de la información que contengan y de la forma en que utilice su equipo, pueden utilizarse para reconocer al usuario.
        </p>

        <h2 className="text-2xl font-bold mt-8 mb-4 text-[#FBBF24] font-heading">2. ¿Qué tipos de cookies utiliza esta página web?</h2>
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4 text-[#FBBF24] font-heading">3. Desactivación o eliminación de cookies</h2>
        <p className="mb-4">
        ...
        <ul className="list-disc list-inside mb-6 space-y-2 ml-4 text-[#FBBF24]">
          <li><a href="https://support.google.com/chrome/answer/95647?hl=es" target="_blank" rel="noopener noreferrer" className="hover:underline font-semibold">Google Chrome</a></li>
          <li><a href="https://support.mozilla.org/es/kb/habilitar-y-deshabilitar-cookies-sitios-web-rastrear-preferencias" target="_blank" rel="noopener noreferrer" className="hover:underline font-semibold">Mozilla Firefox</a></li>
          <li><a href="https://support.apple.com/es-es/guide/safari/sfri11471/mac" target="_blank" rel="noopener noreferrer" className="hover:underline font-semibold">Safari</a></li>
        </ul>
